...
enum TeachingPackTab { objectives, sequence, brief, notes, teach }
...
class _ResultWorkspaceState extends State<_ResultWorkspace> {
  ...
  List<_PackItem> get _items {
    return [
      ...
      const _PackItem(
        tab: TeachingPackTab.teach,
        label: 'Teach',
        detail: 'Explanation, example, and adaptations',
      ),
    ];
  }
  ...
  Widget build(BuildContext context) {
    ...
    final stage = _PresenterCard(
      ...
      showTeach: selected == TeachingPackTab.teach,
  ...
  Widget _packBody(TeachingPackTab tab) {
    switch (tab) {
      ...
      case TeachingPackTab.teach:
        return _TeachOnBoardCue(
          accent: widget.accent,
          onOpenStudio: () {
            TeachScreen.open(
              context,
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        Text(
          'The teaching studio is on the board. Explanation, example, and questions live in the lesson panel.',
          style: SyntraTheme.sans(
            color: SyntraPalette.navy,
            fontSize: 16,
            height: 1.45,
        ...
        SizedBox(
          ...
          child: Material(
            ...
            borderRadius: BorderRadius.circular(12),
            child: InkWell(
              key: const ValueKey('teaching-pack-open-studio'),
              onTap: onOpenStudio,
              borderRadius: BorderRadius.circular(12),
              child: Padding(
                padding: const EdgeInsets.symmetric(
