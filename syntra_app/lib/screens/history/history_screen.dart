...
PipelineTexts? _pipelineFrom(LessonRecord record) {
  ...
  return PipelineTexts(
    learningObjectives: teacher?['learningObjectives'] as String?,
    prerequisiteAnalysis: teacher?['prerequisiteAnalysis'] as String?,
    curriculum: record.markdown,
    lessonPlan: teacher?['lessonPlan'] as String?,
    slides: teacher?['slides'] as String?,
    assessment: (quiz?['markdown'] as String?) ??
        (teacher?['assessment'] as String?),
    knownKnowledge: teacher?['knownKnowledge'] as String?,
  );
}
