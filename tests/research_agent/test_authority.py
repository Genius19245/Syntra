...
def test_curriculum_question_prefers_named_exam_board_over_nasa():
    aqa_key = contextual_sort_key(AQA, exam_board="AQA", question_intent="curriculum")
    nasa_key = contextual_sort_key(NASA, exam_board="AQA", question_intent="curriculum")
...
def test_evaluate_source_returns_metadata():
    result = evaluate_source(NASA, exam_board="", question_intent="scientific_claim")
